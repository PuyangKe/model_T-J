...
function run = SCION_initialise(runcontrol)
    ...
    pars.eps_denit_wc   = 25;   % water column denitrification ε(‰) 15–25
    pars.eps_denit_sed  = 2;    % Sedimentary denitrification ε(‰)  0–5
    pars.eps_assim      = 6;    % assimilation fractionation ε(‰)  4–7
    pars.K_NO3          = 10;   % Suppression scale for assimilation fractionation (µM) 5–15

    % river and runoff N
    pars.riv_runoff_scale = 1.0;     % runoff amplification coefficient (0.5–2)
    pars.d15N_riv_base    = 4;       % river  δ15N basic
    pars.alpha_riv_d15N   = 3;       % Increase of riverine δ15N per unit of (Qnorm − 1)

    % volcanism N（with DEGASS）
    pars.k_volcN      = 1.0e11;  % mol/yr per DEGASS=1 
    pars.d15N_volcN   = 0;       % volcanic δ15N ~0‰
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    pars.kfire= 3 ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Reference land-area-weighted mean runoff (mm/yr) used for Q normalization
    pars.Qref_runoff = 300; % mm/yr — modern land-area-weighted mean runoff (267 - 339 mm/yr) 
